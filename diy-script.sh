...
# 修改密码
sed -i 's|root:x:/root:/bin/ash|root:$6$vMX8CbpYQaZv6.OU$0a3NMGYsjRdW9IRarTzFppsm2FvzwJxfZv9Vh6XwDUd3gaU0QGCWR7VBmH0NzImHvcQ38h8LIopx0QLOP.Kya0:0:0:root:/root:/bin/bash|' package/base-files/files/etc/passwd
