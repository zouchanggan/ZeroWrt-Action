...
# 版本设置
sed -i 's/boardinfo.release.description + '\'' \/ '\'' : '\'''\''/'\''ZeroWrt-Super-Rockchip-v24.10 by OPPEN321 \/ '\''/g' feeds/luci/modules/luci-mod-status/htdocs/luci-static/resources/view/status/include/10_system.js
